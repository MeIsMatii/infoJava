...
1. **Update Library Paths:** Go to **File > Project Structure > Libraries > GreenfootLibs** and update the path to point to your local installation.
2. **Update VM Options:** If you change the library path, you **must** update your **Run Configuration VM options** in IntelliJ, or the project will fail to build/run.
